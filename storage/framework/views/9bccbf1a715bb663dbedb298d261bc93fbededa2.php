        ...
        <main>
            <div class="row contacts">
                ...
                <div class="col invoice-details">
                    <h1 class="invoice-id">INVOICE 00<?php echo e($invoice->invoiceid); ?></h1>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tbody>
                    <tr>
                        <td class="no">01</td>
                        <td class="text-left"><h3>Location:<?php echo e($trips->location); ?> <br>Trip Date:<?php echo e($trips->start_date); ?><br>Boat ID:<?php echo e($trips->boatid); ?> </h3></td>
                        <td class="qty"><?php echo e($trips->reservedseats); ?></td>
                        <td class="unit">$200.00</td>
                        <td class="total">$<?php echo e($trips->reservedseats); ?>*100+200</td>
                    </tr>
                    <tr>
                        <td class="no">02</td>
