        ...
        <header>
                ...
                <div class="alert alert-primary" role="alert" style="width:600px" id="abc" ">
                 <div>
                                ...
                                <span class="badge badge-danger"><?php echo e($wordCount); ?></span>
                                </i>
                                <input type="hidden" value="<?php echo e($wordCount); ?>" id="count">
                                <p style="">You have got <?php echo e($wordCount); ?> requests to confirm </P>
