        ...
        <main>
            ...
            <table border="1" cellspacing="0" cellpadding="0">
                ...
                <tbody>
                    <tr>
                        <td class="no">01</td>
                        <td class="text-left"><p>Location:<?php echo e($trips->location); ?> <br>Trip Date:<?php echo e($trips->start_date); ?><br>Boat ID:<?php echo e($trips->boatid); ?> </p></td> 
                        <td class="qty"><?php echo e($Noofseats); ?></td>
                    <td><?php echo e($priceperhead); ?></td>
                    
                        <td class="total"><?php echo e($finalprice); ?></td>
                    </tr>
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($discountedprice); ?></td>
                    </tr>
                    <tr>
                        <td colspan="2"></td>
