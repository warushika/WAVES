     ...
     <div class="mask flex-center rgba-black-strong text-white">
        <div class="container">
            ...
            <div class="row">
              ...
              <div class="row">
                  <div class="col-md-2">
                        <a  href="<?php echo e(route('login')); ?>"><button class="btn btn-outline-warning btn-lg"><?php echo e(__('Login')); ?></button></a>
                  </div>
                  <div class="col-md-2">
                       <a href="<?php echo e(route('register')); ?>">  <button class="btn btn-outline-warning btn-lg"><?php echo e(__('Register')); ?></button></a>
                  </div>
