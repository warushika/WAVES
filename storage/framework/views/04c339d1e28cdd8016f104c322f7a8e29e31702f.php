...
<div class="row">
        <div class=" col-md-12">
        <img src="storage/cover_images/<?php echo e($home->cover_image); ?>" alt="" class="header-img ">
        </div>
...
<div class="row"  style="margin-top:-250px">
        ...
        <div class="col-md-4  " >
            <img src="storage/profile_image/<?php echo e($home->profile_image); ?>" alt="" class="img-fluid" style="">
        ...
        <h1><?php echo e($home->boatname); ?></h1>
            <br>
        <p><?php echo e($home->body); ?></p>
...
<div class="row mb-5 mt-5 " >
    <div class="col-md-4 card jumbotron" style="padding-top:50px">
      <?php  $name=auth()->user()->name; ?>
        ...
        <p>boat id:<span style="color:black"><?php echo e($home->boatid); ?></span></p>
        <p>registration no:<span style="color:black"><?php echo e($home->registrationnumber); ?></span></p>
        <p>Available seats:<span style="color:black"><?php echo e($home->availableseats); ?></span></p>
        <p>Reserved seats:<span style="color:black"><?php echo e($home->receivedseats); ?></span></p>
        <p>next trip date:<span style="color:black"><?php echo e($home->reservationdate); ?></span></p>
        <p>Location:mirissa harbour</p>
        <p>starts at:</p>
        <a href="/boats/<?php echo e($home->boatid); ?>/edit" class="btn btn-primary">EDIT</a>
